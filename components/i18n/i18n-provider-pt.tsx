export const ptTranslations = {
  ...
  "tableMaps": {
    ...
    "description": "Gerencie os layouts das mesas em seu negócio",
  ...
  "tableDialog": {
    ...
    "description": "Crie uma nova mesa para seu negócio",
    "labels": {
  ...
  "tables": {
    ...
    "tableMaps": {
      ...
      "mapDescription": "Descrição do Mapa",
      "noMapsFound": "Nenhum Mapa de Mesa Encontrado",
      "createMapDescription": "Crie um novo mapa de mesa para seu negócio",
  ...
  "dashboard": {
    ...
    "user": "Usuário",
    "welcomeMessage": "Bem-vindo ao seu dashboard, onde você pode gerenciar as operações do seu negócio e rastrear desempenho.",
  ...
  "inventory": {
    ...
    "subtitle": "Gerencie o estoque do seu negócio",
  ...
  "users": {
    ...
    "hasBeenDeleted": "Usuário excluído",
    "errors": {
  ...
  "register": {
    "title": "Registro",
    "subtitle": "Crie uma nova conta para acessar o sistema de gerenciamento",
    "username": "Nome de Usuário",
    ...
    "suggestedNames": {
      ...
      "description": "O nome que você inseriu já está em uso. Por favor, selecione um nome alternativo:",
  ...
  "settings": {
    ...
    "profile": {
      ...
      "fields": {
        ...
        "email": {
          "label": "Email",
          "cannotBeChanged": "Este email não pode ser alterado"
        },
    ...
    "company": {
      ...
      "actions": {
        "submit": "Salvar Alterações",
        "submitting": "Salvando...",
        "companyUpdated": "Configurações da empresa atualizadas",
        "companyUpdateSuccess": "Suas configurações da empresa foram atualizadas com sucesso.",
        "companyUpdateFailed": "Falha ao atualizar configurações da empresa",
        "companyUpdateError": "Ocorreu um erro ao atualizar suas configurações da empresa."
      }
    },
    "security": {
      "title": "Segurança",
